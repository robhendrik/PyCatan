...
# python scripts/RL_training_loop_clean_script.py --rounds 2 --train_games 1 --test_games 1  
# python scripts/RL_training_loop_clean_script.py --rounds 2 --train_games 12 --test_games 1  
# python scripts/RL_training_loop_clean_script.py --rounds 2 --train_games 8 --test_games 2 --parallel --n_jobs 2
...
def main(args):
    ...
    for round_idx in range(args.rounds):
        ...
        # pycatanbucket
        save_to_s3(save_path, "your-bucket-name", f"models/{save_path}")
